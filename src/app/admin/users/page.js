          ...
          <table className="w-full">
            <thead className="bg-[#1e293b]">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-sm font-medium text-gray-300">E-Mail</th>
                <th className="px-6 py-4 text-left text-sm font-medium text-gray-300">Rolle</th>
                <th className="px-6 py-4 text-left text-sm font-medium text-gray-300">Registriert</th>
