    ...
    <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:items-stretch">
          ...
          >
            ...
            <div className="flex-1 flex flex-col min-h-35">
              ...
              <textarea
                ...
                className="w-full flex-1 min-h-35 px-4 py-3 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-[#141738] text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-pink-500 text-sm resize-none transition-all"
              />
            </div>
        ...
        <div className="lg:col-span-5 flex flex-col justify-between gap-6 h-full">
          ...
          {/* Map Embed */}
          <div className="flex-1 min-h-65 rounded-3xl overflow-hidden shadow-xl border border-slate-200 dark:border-slate-800 w-full">
            <iframe
              ...
              className="w-full h-full min-h-65"
            />
          </div>
        </div>
      </div>
